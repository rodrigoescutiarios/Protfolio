...
import { BookOpen, Code, Rocket, Users, CheckCircle, Calendar, MessageCircle, Zap, Target, Lightbulb, Clock, TrendingUp, Mail, Linkedin, Github, Building2 } from 'lucide-react';
